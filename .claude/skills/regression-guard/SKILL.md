...
| --------- | ---------- | --------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `61b41a5` | 2026-05-14 | fix(outbox): idempotencia locale-safe via onConflictDoNothing                                 | `apps/api/src/workers/outbox-publisher.ts`                                                                                                                                                                                                                                          |
| `bfa732e` | 2026-05-14 | fix(kanban-ui): drag&drop funcional e overlay alinhado ao cursor                              | `apps/web/src/components/kanban/KanbanCard.tsx`<br>`apps/web/src/components/kanban/KanbanColumn.tsx`<br>`apps/web/src/hooks/kanban/useMoveCard.ts`<br>`apps/web/src/pages/kanban/KanbanPage.tsx`<br>`apps/web/src/styles/globals.css`                                               |
