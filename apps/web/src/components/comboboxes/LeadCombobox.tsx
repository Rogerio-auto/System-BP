// =============================================================================
// components/comboboxes/LeadCombobox.tsx — Combobox compartilhado de lead.
//
// Busca live em GET /api/leads?search=<termo>&limit=20.
// Bug fix: parâmetro era `q`, corrigido para `search` (alinhado ao schema).
// Debounce 300ms. Não dispara para queries < 2 chars.
//
// Exibe: nome (semibold) + email em JetBrains Mono + Badge de status.
// LGPD: nunca exibe CPF bruto. Telefone mascarado via maskPhone().
//
...
async function searchLeads(search: string): Promise<LeadResponse[]> {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {lead.email && (
                          <p className="font-mono text-xs text-ink-3 truncate">{lead.email}</p>
                        )}
                      </div>
