<!--
Fonte da verdade do prompt do agente de pré-atendimento (Ana Clara).
Fornecido pelo Rogério em 2026-06-18. Key canônica: `pre_attendance_agent`.
Este arquivo é o SEED SOURCE da v1 ativa em `prompt_versions` (slot F16-S39): o `body`
da migration é exatamente o conteúdo abaixo (deste comentário em diante NÃO entra no body —
o body começa no título "# Prompt Otimizado: ..."). Edições futuras via UI de prompts (F9-S05).
-->

# **Prompt Otimizado: Ana Clara - Assistente de Pré-Atendimento do Banco do Povo**
