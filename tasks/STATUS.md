...
| F10-S15 | Template MDX canônico + meta-guia "Como escrever uma página de ajuda" | 🟢 available | low        | F10-S14          |

## Fase 12 —

| ID      | Título                                                         | Status         | Prioridade | Depende de       |
| ------- | -------------------------------------------------------------- | -------------- | ---------- | ---------------- |
| F12-S01 | Schema feature_tutorials + migration + catálogo de feature_key | 🔵 in-progress | medium     | —                |
| F12-S02 | API /api/help/tutorials + /api/admin/tutorials CRUD + RBAC     | ⏸️ blocked     | medium     | F12-S01          |
| F12-S03 | Componente <VideoTutorial> provider-aware + registro no MDX    | 🟢 available   | medium     | —                |
...
| F12-S06 | Instrumentar telas do app com <ContextualHelp featureKey>      | ⏸️ blocked     | low        | F12-S04, F12-S05 |
