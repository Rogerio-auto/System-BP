...
| ID      | Título                                                         | Status         | Prioridade | Depende de       |
| ------- | -------------------------------------------------------------- | -------------- | ---------- | ---------------- |
| F12-S01 | Schema feature_tutorials + migration + catálogo de feature_key | 🟢 available   | medium     | —                |
| F12-S02 | API /api/help/tutorials + /api/admin/tutorials CRUD + RBAC     | ⏸️ blocked     | medium     | F12-S01          |
| F12-S03 | Componente <VideoTutorial> provider-aware + registro no MDX    | 🔵 in-progress | medium     | —                |
