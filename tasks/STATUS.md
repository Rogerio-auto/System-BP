...
| ID      | Título                                                                                   | Status         | Prioridade | Depende de                |
| ------- | ---------------------------------------------------------------------------------------- | -------------- | ---------- | ------------------------- |
| F25-S01 | DB — canonical_role em kanban_stages + ator 'ai' no audit + event types do funil         | 🔵 in-progress | high       | —                         |
...
| ID     | Título                                                                                     | Status       | Prioridade | Depende de     |
| ------ | ------------------------------------------------------------------------------------------ | ------------ | ---------- | -------------- |
| F6-S05 | DB/Seed — ai_assistant:use + flag ai.internal_assistant.enabled + tabela assistant_queries | 🟢 available | high       | —              |
