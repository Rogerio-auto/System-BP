...
| F0-S17  | Fix CI — shared-schemas typecheck (zod resolution + any implícito) + flaky rate-limit test | 🟣 review      | critical   | —                              |
| F0-S18  | Fix CI — langgraph Dockerfile não encontra uvicorn em runtime (4ª camada do destrava-CI)   | 🔵 in-progress | critical   | —                              |
...
| F8-S18 | Frontend — plugar Cobrança + Templates WhatsApp no Hub de Configurações                       | 🟢 available | high       | —                              |
