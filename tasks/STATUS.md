...
| F4-S02 | Backend — service + endpoints CRUD de credit_analyses (RBAC + Art. 20) | 🟣 review    | critical   | F4-S01, F1-S04, F1-S15, F1-S16         |
...
| F7-S03 | Hardening F3 pré-produção (timing-safe token, multi-tenant scope, idempotency, logs) | 🔵 in-progress | critical   | F3-S33, F3-S34, F9-S10                         |
