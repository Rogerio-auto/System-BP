...
| ID     | Título                                                                      | Status         | Prioridade | Depende de             |
| ------ | --------------------------------------------------------------------------- | -------------- | ---------- | ---------------------- |
| F9-S00 | Schema model_pricing — preços por modelo LLM (USD) + FX para BRL            | 🟢 available   | high       | —                      |
| F9-S01 | Backend — API de prompt_versions (CRUD + ativação transacional)             | 🔵 in-progress | high       | F3-S01, F1-S04, F1-S16 |
| F9-S02 | Backend — API read de ai_decision_logs (lista + timeline, city-scoped)      | 🟢 available   | high       | F3-S01, F9-S00, F1-S04 |
