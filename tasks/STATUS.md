...
| F20-S08 | Backend — deprecar env vars META_WHATSAPP_* após migração completa para channels                                             | ✅ done | low        | F20-S03, F20-S04, F20-S05, F20-S06 |
...
| ID      | Título                                                                   | Status | Prioridade | Depende de       |
| ------- | ------------------------------------------------------------------------ | ------ | ---------- | ---------------- |
| F26-S01 | Frontend — lista do sino acionável (navegar + ação + ler ao abrir)       | ✅ done | high       | —                |
| F26-S02 | Backend — enriquecer contexto das notificações (handoff, escalação, SLA) | ✅ done | high       | —                |
| F26-S03 | Backend — persistir severidade na linha da notificação + expor no REST   | ✅ done | medium     | —                |
| F26-S04 | Frontend — central de notificações (/notificacoes) + severidade na lista | ✅ done | medium     | F26-S01, F26-S03 |
...
| F27-S07 | Frontend — push client (SW handlers + opt-in) + SocketProvider global                       | ✅ done | high       | F27-S01, F27-S03, F27-S06          |
| F27-S08 | QA — verificação PWA (installability/Lighthouse, offline, push e2e, auth standalone)        | ✅ done | medium     | F27-S01, F27-S02, F27-S06, F27-S07 |
| F27-S09 | Docs LGPD — RoPA de push_subscriptions (doc 17 §3.3/§3.4)                                   | ✅ done | high       | F27-S06                            |
...
| F28-S03 | Backend — módulo CRUD de respostas rápidas (RBAC, audit, realtime) | ✅ done | critical   | F28-S01, F28-S02 |
| F28-S04 | Backend — mídia da biblioteca (signed URL) e telemetria de uso     | ✅ done | high       | F28-S03          |
| F28-S05 | Frontend — camada de dados de respostas rápidas + realtime         | ✅ done | high       | F28-S02          |
...
| ID      | Título                                                                                 | Status        | Prioridade | Depende de |
| ------- | -------------------------------------------------------------------------------------- | ------------- | ---------- | ---------- |
| F29-S01 | Backend — enriquecer notificação de handoff (cidade via lead + nome do cliente in-app) | 🔵 in-progress | high       | —          |
| F29-S02 | Frontend — deep-link do sino abre a conversa específica (não só o inbox)               | 🟢 available   | high       | —          |
...
| F6-S29 | Frontend — barra lateral de histórico do copiloto (listar, abrir, continuar, renomear)     | ✅ done      | medium     | F6-S25, F6-S28  |
