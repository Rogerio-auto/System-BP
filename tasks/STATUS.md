...
| F6-S12 | Frontend — workspace fullscreen do copiloto (markdown + chips de sugestão por role)        | 🟢 available   | medium     | F6-S09         |
| F6-S13 | Backend — endpoint interno de leitura da conversa do lead (para resumo do copiloto)        | 🔵 in-progress | medium     | F6-S06         |
