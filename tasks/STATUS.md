...
| F8-S08 | Frontend — Hub de Configurações + reorganização da Administração         | 🔵 in-progress | medium     | —                              |
| F8-S09 | Conta — self-service de perfil, senha e aparência (backend + frontend)   | 🟢 available   | medium     | F8-S08                         |
