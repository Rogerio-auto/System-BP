...
| F0-S16  | Fix vitest + @fastify/autoload (forceESM) — env.js não resolve em integração  | 🟣 review | high       | —                              |
...
| F9-S11 | Fix dry-run GET /internal/conversations/:id/state — retorna shape errado        | 🟣 review | high       | —                      |
