...
| F6-S24 | DB — schema de conversas e turnos do copiloto (sem PII em repouso)                         | 🔵 in-progress | medium     | F6-S20          |
| F6-S25 | Backend — persistência + CRUD das conversas do copiloto (nomeação por intenção)            | 🟢 available   | medium     | F6-S24, F6-S21  |
