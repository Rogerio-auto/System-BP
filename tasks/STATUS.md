...
| F8-S03 | Backend endpoint /api/dashboard/metrics (KPIs agregados)                 | 🔵 in-progress | medium     | F1-S04, F1-S09, F1-S11, F1-S13 |
...
| F8-S07 | Promover roles.scope a coluna real (migration + backfill) e ler do banco | 🟢 available   | medium     | F8-S06                         |
